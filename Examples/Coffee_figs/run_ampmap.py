...
plt.imshow(data_array, cmap='plasma', vmin=1.5, vmax=10, aspect='auto')


lc_ini_x = coordinate_to_grid(pos_ini_x, pos_fin_x, lc_steps, -0.5)
lc_fin_x = coordinate_to_grid(pos_ini_x, pos_fin_x, lc_steps, 1.5)
...
plt.scatter(lens_1_x, lens_1_y, marker='o', facecolors='none', edgecolors='white', s=100)
plt.scatter(lens_2_x, lens_2_y, marker='o', facecolors='none', edgecolors='white', s=100)
plt.scatter(lens_3_x, lens_3_y, marker='o', facecolors='none', edgecolors='white', s=100)
...
plt.xticks(x_grid_range, labels=[f'{float(val):.1f}' for val in x_label_range])
plt.yticks(y_grid_range, labels=[f'{float(val):.1f}' for val in y_label_range])


plt.savefig('amplification_map.svg')
