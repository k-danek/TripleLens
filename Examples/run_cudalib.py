...
#lib_cuda_test = ctypes.cdll.LoadLibrary('../bin/liblccuda.so')
#print(lib_cuda_test)
#print(lib_cuda_test.baseReturn())
#lib_cuda_test.testFunction(111)
#
##cuda_load_test = Cuda_load_test()
##cuda_load_test.testFunction(313) 
#lib_cuda_test.testFunction(123)
