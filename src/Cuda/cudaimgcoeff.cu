...
{
  thrust::complex<double> z2(params[3], params[4]);   
  thrust::complex<double> z2c(params[3], -params[4]);   
  thrust::complex<double> z3(params[5], params[6]);   
  thrust::complex<double> z3c(params[5], -params[6]);   
  double m2 = params[1]; 
  double m3 = params[2]; 
...
//__device__
//complex<double>* ImgPoint::getCoeffsOpt()
//{
...
//
//  return <complex<double>{a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10};  
//}
...
void getCoeffsBinOpt(thrust::complex<double>* coeffs, thrust::complex<double> zeta)
{
  ...
  thrust::complex<double> a5 = -t1+zetac*params[3];
  thrust::complex<double> t6 = 2.0*t1*params[3];
  thrust::complex<double> t7 = params[3]*params[3];
  thrust::complex<double> t11 = params[1]*params[3];
  thrust::complex<double> a4 = -a5*zeta+t6+(-1.0-2.0*t7)*zetac+params[3]-t11;
  thrust::complex<double> t17 = t1*t7;
  thrust::complex<double> t18 = 2.0*t11;
  thrust::complex<double> t19 = t7*params[3];
  thrust::complex<double> t22 = params[1]*t7;
  thrust::complex<double> a3 = (-t6+(2.0*t7+2.0)*zetac-params[3])*zeta-t17+(t18+t19)*zetac-t7+t22;
  thrust::complex<double> a2 = (t17+(-2.0*params[3]-t19-t18)*zetac+t22+1.0+t7)*zeta+(-2.0*t22+t7)*zetac-params[3]+t11;
  thrust::complex<double> a1 = (2.0*t7*zetac*params[1]+t11*(-2.0-t7))*zeta+t11*(params[3]-t11);
  thrust::complex<double> a0 = zeta*params[1]*params[1]*t7;
